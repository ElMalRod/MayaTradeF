...
function UserNavbar({handleShowProducts}) {
  ...
  return (
    <div className="bg-[#F6F5F5] w-[100%] grid grid-cols-1 place-content-start justify-items-center gap-2 p-2 text-lg text-gray-600">
      {/* Logo */}
      <a className="bg-blue-100n grid place-content-center p-4 cursor-pointer" href='/publicador'>
      ...
      <a className="h-[25px] w-full cursor-pointer hover:bg-gray-300 rounded-xl mx-2 flex items-center p-4" href='/publicador/publicaciones'>
        <PreviewIcon className="text-gray-600" />
        <p className="pl-2"> Mis Publicaciones </p>
      </a>

      <a className="h-[25px] w-full cursor-pointer hover:bg-gray-300 rounded-xl mx-2 flex items-center p-4" href='/publicador/chat'>
      ...
      <a className="h-[25px] w-full cursor-pointer hover:bg-gray-300 rounded-xl mx-2 flex items-center p-4" href='/publicador/productos'>
        <CategoryIcon className="text-gray-600" />
        <p className="pl-2"> Productos </p>
      </a>

      <a className="h-[25px] w-full cursor-pointer hover:bg-gray-300 rounded-xl mx-2 flex items-center p-4" href='/publicador/servicios'>
